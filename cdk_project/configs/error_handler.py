...
class ErrorHandler:
    ...
    @staticmethod
    def validate_path_exists(path: Union[str, Path], path_type: str = "Path") -> None:
        """Validate that a path exists and is a directory."""
        if not Path(path).is_dir():
            raise FileNotFoundError(f"{path_type} not found: {path}")
    
    @staticmethod
    def validate_file_exists(file_path: Union[str, Path], file_type: str = "File") -> None:
    ...
    @staticmethod
    def validate_field_structure(data: Dict[str, Any], field_name: str, required_subfields: List[str], context: str = "Configuration") -> None:
    ...
    @staticmethod
    def validate_enum_value(value: Any, valid_values: List[Any], field_name: str, context: str = "Configuration") -> None:
        """Validate that a value is one of the allowed enum values."""
        if value not in valid_values:
            raise ValueError(f"{context} field '{field_name}' must be one of: {', '.join(map(str, valid_values))}")
    
    @staticmethod
    def validate_not_empty(value: Any, field_name: str, context: str = "Configuration") -> None:
    ...
    @staticmethod
    def validate_type(value: Any, expected_type: type, field_name: str, context: str = "Configuration") -> None:
    ...
    @staticmethod
    def validate_positive_integer(value: Any, field_name: str, context: str = "Configuration") -> None:
        """Validate that a value is a positive integer."""
        if not isinstance(value, int) or value <= 0:
            raise ValueError(f"{context} field '{field_name}' must be a positive integer")
    
    @staticmethod
    def validate_boolean(value: Any, field_name: str, context: str = "Configuration") -> None:
        """Validate that a value is a boolean."""
        if not isinstance(value, bool):
            raise ValueError(f"{context} field '{field_name}' must be a boolean")
    
    @staticmethod
    def validate_string_not_empty(value: Any, field_name: str, context: str = "Configuration") -> None:
        """Validate that a value is a non-empty string."""
        if not isinstance(value, str) or value.strip() == "":
            raise ValueError(f"{context} field '{field_name}' must be a non-empty string")
    
    @staticmethod
    def validate_list_not_empty(value: Any, field_name: str, context: str = "Configuration") -> None:
        """Validate that a value is a non-empty list."""
        if not isinstance(value, list) or len(value) == 0:
            raise ValueError(f"{context} field '{field_name}' must be a non-empty list")
    
    @staticmethod
    def validate_dict_not_empty(value: Any, field_name: str, context: str = "Configuration") -> None:
    ...
    @staticmethod
    def validate_key_exists(key: Any, container: Dict[str, Any], key_name: str, context: str = "Configuration") -> None:
        """Validate that a key exists in a dictionary."""
        if key not in container:
            raise KeyError(f"{context} key '{key_name}' not found in container")
    
    @staticmethod
    def validate_lambda_exists(lambda_name: str, lambdas: Dict[str, Any], context: str = "Configuration") -> None:
    ...
    @staticmethod
    def validate_config_files_provided(config_files: Any, context: str = "Configuration") -> None:
        """Validate that config files are provided."""
        if not config_files:
            raise ValueError(f"No config_files provided to {context}")
    
    @staticmethod
    def validate_configs_found(configs: List[Any], context: str = "Configuration") -> None:
        """Validate that configurations were found."""
        if not configs:
            raise ValueError(f"No {context} configurations found")
    
    @staticmethod
    def validate_context_keys(missing_keys: List[str], context: str = "Configuration") -> None:
...
class ValidationDecorators:
    ...
    @staticmethod
    def validate_path_exists(path_param: str, path_type: str = "Path"):
    ...
    @staticmethod
    def validate_file_exists(file_param: str, file_type: str = "File"):
    ...
    @staticmethod
    def validate_required_config_fields(required_fields: List[str], config_param: str = "conf", context: str = "Configuration"):
    ...
    @staticmethod
    def validate_service_name(service_param: str = "service_name"):
...
def validate_table_config(conf: Dict[str, Any], table_name: str) -> None:
    ...
    ErrorHandler.validate_field_structure(conf, "partition_key", ["name", "type"], f"Table configuration for {table_name}")
    
    # Validate sort_key structure if present
    if "sort_key" in conf:
        ErrorHandler.validate_field_structure(conf, "sort_key", ["name", "type"], f"Table configuration for {table_name}")

def validate_lambda_config(conf: Dict[str, Any], lambda_name: str) -> None:
...
def validate_websocket_api_config(conf: Dict[str, Any], api_name: str) -> None:
    ...
    ErrorHandler.validate_field_structure(conf, "stage", ["name", "auto_deploy"], f"WebSocket API configuration for {api_name}")

def validate_route_config(conf: Dict[str, Any], route_file: str) -> None:
    ...
    ErrorHandler.validate_field_structure(conf, "integration", ["type", "lambda_name"], f"Route configuration in {route_file}")
    
    # Validate integration type
    ErrorHandler.validate_enum_value(conf["integration"]["type"], ["lambda"], "type", f"Route integration in {route_file}")
